...
(function () {
    ...
    if(sel&&sel.group==="Fluency"){
      ...
      if(stF)stF.addEventListener("change",function(){
        ...
        flW.addEventListener("click",function(e){
          ...
          var allW=flW.querySelectorAll(".hrt-fw");
          allW.forEach(function(x){if(x.dataset.state==="1"){x.dataset.state="0";x.style.background="";x.style.color="";}});
          if(sp.dataset.state==="2"){sp.dataset.state="0";sp.style.background="";sp.style.color="";}
          else if(sp.dataset.state==="0"){if(!flW.querySelector("[data-state='1']")&&sp.dataset.state!=="2"){sp.dataset.state="2";sp.style.background="#fee2e2";sp.style.color="#dc2626";}}
          if(!flW.querySelector("[data-state='1']")){sp.dataset.state="1";sp.style.background="#dcfce7";sp.style.color="#15803d";}
        });
      });
    }
  ...
  function showHrtStudentFile(el,d,sel){
    ...
    if(sel.group==="Sight Words"){
      ...
      HR_STORIES.forEach(function(s){h+="<option value='"+s.id+"'>Story "+s.id+": "+s.t+"</option>";});
